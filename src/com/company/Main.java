...
public class Main
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Key.encoded returns the bytes making up the key material
        System.out.println("key: " + CryptoUtils.toHex(encryptionKey.getEncoded()));
        ...
        System.out.println("cipher: " + CryptoUtils.toHex(cipherText, ctLength) + " bytes: " + ctLength);

        //key.getAlgorithm returns the name of the Algorithm that the key is for
        ...
        System.out.println("plain: " + CryptoUtils.toHex(plainText, ptLength) + " bytes: " + ptLength);
    }
}
